...
import com.wanding.face.adapter.ShiftRecordAdapte;
import com.wanding.face.bean.ShiftRecordListResData;
...
import com.wanding.face.payutil.SettlementDateUtil;
...
public class ShiftRecordActivity extends BaseActivity implements OnClickListener,ShiftRecordAdapte.OnSetRecordDetail,XListView.IXListViewListener {
...
//                timeSelector.setMode(TimeSelector.MODE.YMD);//只显示 年月日
	...
	public void getDetail(ShiftRecordResData record) {
		...
		intent.setClass(this, ShiftRecordDetailActivity.class);
