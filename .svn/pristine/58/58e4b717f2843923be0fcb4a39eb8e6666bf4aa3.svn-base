...
import com.wanding.face.facetest.IFSExampleActivity;
import com.wanding.face.httputil.NetworkUtils;
import com.wanding.face.utils.SnackbarAction;
import com.wanding.face.utils.ToastUtil;
import com.wanding.face.view.CustomDialog;
...
//        waitingDialog.setTitle("我是一个等待Dialog");
    ...
    public void showCustomDialog(String msg) {
        ...
        if (myCustomDialog == null) {
            myCustomDialog = CustomDialog.CreateDialog(activity,msg);
    ...
    public void hideCustomDialog() {
        if (myCustomDialog != null && !(this.isFinishing() || this.isDestroyed())) {
